...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "KRPT";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "KRPT";
    ...
    const std::string daemonName = "Kryptod";

    /* The name to call this wallet */
    const std::string walletName = "kryptowallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "krypto-service";
