...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "eP";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "eP";
    ...
    const std::string daemonName = "ePesad";

    /* The name to call this wallet */
    const std::string walletName = "e-wallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "e-service";
